...
import { DatePickerCalendarYearGridCell } from "./date-picker-calendar-year-grid-cell";
...
export const DatePickerCalendarYearGrid = () => {
  return (
    <chakra.div
      maxH="188px"
      overflowY="auto"
          ...
          >
            {listWithThreeItems.map((year, index) =>
              year == null ? (
                ...
                <DatePickerCalendarYearGridCell key={year} year={year} />
              ),
            )}
          </chakra.div>
        );
